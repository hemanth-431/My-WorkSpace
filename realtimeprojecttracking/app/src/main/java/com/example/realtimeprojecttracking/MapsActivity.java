    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    String latitude = dataSnapshot.child("latitude").getValue().toString();//.substring(1, dataSnapshot.child("latitude").getValue().toString().length()-1);
                    String longitude = dataSnapshot.child("longitude").getValue().toString();//.substring(1, dataSnapshot.child("longitude").getValue().toString().length()-1);
/*
System.out.println(databaseLatitudeString+" *** ");
System.out.println(databaseLongitudedeString+" *** ");
